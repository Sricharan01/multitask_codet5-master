...
from data_utils import CQADatasetLoader, PYTHONDatasetLoader, SVAMPDatasetLoader, ESNLIDatasetLoader, ANLI1DatasetLoader, ASDivDatasetLoader
...
def run(args):
    ...
    if args.dataset == 'cqa':
        ...
        dataset_loader = PYTHONDatasetLoader()
    else:
        raise ValueError
